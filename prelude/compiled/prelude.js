...
export const concat = (function(x, y) {
    ...
    ? (x + y)
    : (typeof x === "function" && typeof y === "function")
    ? (function(args, y(x.apply(null, args))) {
...
export const map = (function(x, mapper) {
    ...
    : (typeof x === "string" || (typeof x === "number" && !(Number.isNaN(x))))
    ? mapper(x)
    : typeof x === "function"
    ? (function(args) {
    ...
    ? x.map(mapper)
    : (!(null == x) && x.constructor === Object)
    ? Object.entries(x).reduce((function(o, k_v$3) {
    ...
    x.entries().forEach((function(k_v$4) {
          ...
          return (function(cnt) {
            ...
            (function() {
              if (!(typeof cnt === "function")) {
                return (function() {
                  throw (new Error(("" + "(maybe.concat) cannot\n" +
                  "                                                        concat when both of\n" +
                  "                                                        the carried values\n" +
                  "                                                        implement the\n" +
                  "                                                        semigroup\n" +
...
either[either.right(value)] = undefined;
either.lift = (function(value) {
    
});
either[(!(!(value == null))
  ? either.left((new Error(("" + ""))))
  : either.of(value))] = undefined;
...
either[either.left((new Error(("" + "either-zero"))))] = undefined;
...
either.prototype.concat = (function(tEither) {
    ...
    if (!(either.is(tEither))) {
      return (function() {
        throw (new Error(("" + "(either.concat)" + _eArg1_ + "instance of either, got " + show(tEither))))
      }).call(this);
    }
  }).call(this);
  return this.match({
        ...
        right: (function(tValue) {
          ...
          return (function(cnt) {
            ...
            (function() {
              if (!(typeof cnt === "function")) {
                return (function() {
                  throw (new Error(("" + "(either.concat) cannot\n" +
                  "                                                        concat when both of\n" +
                  "                                                        the carried values\n" +
                  "                                                        implement the\n" +
                  "                                                        semigroup\n" +
